...
class FACHAIGameTableSeeder extends Seeder
{
    /**
    ...
    {
        // Load the JSON file
        $json = File::get(base_path('database/seeders/data/UpdatedFACHAISlot.json'));
        ...
        foreach ($data['Game'] as $game) {
            GameList::create([
                ...
                'product_id' => 13,  // Fixed value for product_id
